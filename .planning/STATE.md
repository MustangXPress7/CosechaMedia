...
- Reasignación de roadmap (2026-09-11, prioridad estética+seguridad para adopción): el bloque de **configuración de proyecto** (plantillas 01.8.0-06, bienvenida I-13 01.8.0-07, orígenes en ProjectWizard 01.8.0-08) pasa de 1.7.0 a **Fase 1.8.0**; el **reporte PDF con miniaturas (I-23+I-05, ex 01.9.0-03)** pasa a **Fase 1.7.0** (01.7.0-06). 1.7.0 queda con 6 planes (01: pulido visual, 02: trigo, 03: verificación R-05, 04: ID-01, 05: ID-02, 06: reportes); 1.8.0 con 8 planes; 1.9.0 con 2 planes (velocidad, resume)
- Integración (2026-09-11): la **Fase 1.9.0 se elimina** — motor de copia (I-20) y resume robusto (I-22) pasan a la **Fase 1.7.0** (planes 01.7.0-07/08) para dar robustez completa al sistema de ingesta tras la reestructuración de orígenes de 1.6.0. 1.7.0 queda con 8 planes; 2.0 pasa a depender de 1.8.0
