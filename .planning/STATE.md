...
| 260821-io6 | Lote de pulido UI: wizard con opciones avanzadas colapsables, WiFi directo al QR (sin diálogo intermedio), orden de botones del lanzador, progreso sin texto hasta finalizar, combo de sesiones elástico, icono llave inglesa, anchos de orígenes (Ruta stretch), flechas de combo triángulo, primarios dependientes del acento | 2026-08-21 | ed71c7e | Needs Review | [260821-io6-ui-polish-batch-wizard-advanced-toggle-d](./quick/260821-io6-ui-polish-batch-wizard-advanced-toggle-d/) |
