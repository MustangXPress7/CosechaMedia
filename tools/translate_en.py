...
TRANSLATIONS = {
    ...
    "Modo": "Mode",
    "Manual": "Manual",
    "Automático (experimental)": "Automatic (experimental)",
    "El modo automático es experimental: detecta la cámara desde un archivo de muestra y puede no funcionar en todas las tarjetas.": "Automatic mode is experimental: it detects the camera from a sample file and may not work on every card.",
    "Tiempo máximo de escaneo": "Maximum scan time",
    "Segundos que espera el modo automático antes de preguntar por la cámara.": "Seconds the automatic mode waits before asking for the camera.",
